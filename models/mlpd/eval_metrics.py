...
#
#     MLPD labels are 1-based (background=0 reserved), same as RetinaNet.
#     MLPD etiketleri 1-based'dir (background=0 ayrilmis), RetinaNet ile ayni.
    ...
    for thr in thresholds:
        ...
        if f1 > best_overall["f1"]:
            ...
            for k, name in enumerate(class_names):
                cls_label = k + 1  # +1 shift (MLPD label)
