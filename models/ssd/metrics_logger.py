# metrics_logger.py
#
# Excel logger for SSD training.
# SSD egitimi icin Excel logger.
#
# SSD's loss dict has two components: bbox_regression and classification.
# SSD'nin loss dict'i iki bilesenli: bbox_regression ve classification.
#
# Layout / Yapi:
