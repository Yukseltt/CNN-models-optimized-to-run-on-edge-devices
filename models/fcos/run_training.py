# run_training.py
#
# Launcher script that starts FCOS training.
# FCOS egitimini baslatan launcher script.
#
# Usage / Kullanim:
...
#   "resnet50_coco"     - FCOS ResNet50+FPN, COCO pretrained (transfer)
#   "resnet50_scratch"  - FCOS ResNet50+FPN, backbone-only ImageNet
...
#
# FCOS-ResNet50 is heavier than SSDLite (~32M params vs ~2.2M); the
...
# FCOS-ResNet50 SSDLite'tan daha agir (~38M vs ~2.2M); host H200 MIG
...
RESNET50_SCRATCH_CFG = {
    ...
    "EPOCHS":       100,
    "PATIENCE":     20,
    "NAME":         "fcos_resnet50_scratch_28.05.2026",
    "OUTPUT_XLSX":  "training_metrics.xlsx",
}
...
RESUME_CFG = {
    ...
    "NAME":         "fcos_resnet50_28.05.2026",
    "OUTPUT_XLSX":  "training_metrics.xlsx",
    "RESUME_FROM":  str(PROJECT_ROOT / "runs" / "fcos_resnet50_28.05.2026" / "last.pt"),
}
