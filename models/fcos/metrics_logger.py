# metrics_logger.py
#
# Excel logger for FCOS training.
# FCOS egitimi icin Excel logger.
#
# FCOS's loss dict has THREE components: bbox_regression, classification,
# bbox_ctrness (centerness, used for low-quality prediction filtering).
# FCOS'nin loss dict'i UC bilesenli: bbox_regression, classification,
# bbox_ctrness (centerness, dusuk-kaliteli tahmin filtrelemesi icin).
#
# Layout / Yapi:
