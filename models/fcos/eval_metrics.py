...
#
#     FCOS labels are 1-based (background=0 reserved), same as FCOS.
#     FCOS etiketleri 1-based'dir (background=0 ayrilmis), FCOS ile ayni.
    ...
    for thr in thresholds:
        ...
        if f1 > best_overall["f1"]:
            ...
            for k, name in enumerate(class_names):
                cls_label = k + 1  # +1 shift (FCOS label)
