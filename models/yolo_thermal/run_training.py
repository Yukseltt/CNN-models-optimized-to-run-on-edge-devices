# run_training.py
#
# Launcher script that starts YOLO-Thermal training.
# YOLO-Thermal egitimini baslatan launcher script.
#
# Usage / Kullanim:
...
from train_yolo_thermal import train


# Run type selector. One of:
# Run tipi seciciyi. Sunlardan biri:
#   "default"  - YOLOv8n base + thermal-aware augmentation (HSV off, geometric on)
...
# Default thermal config / Varsayilan termal config.
DEFAULT_CFG = {
    "EPOCHS":      100,
    "BATCH_SIZE":  32,
    "PATIENCE":    30,
    "NAME":        "yolo_thermal_v8n_28.05.2026",
...
RESUME_CFG = {
    ...
    "NAME":         "yolo_thermal_v8n_28.05.2026",
    "OUTPUT_XLSX":  "training_metrics.xlsx",
    "RESUME_FROM":  str(PROJECT_ROOT / "runs" / "yolo_thermal_v8n_28.05.2026" / "weights" / "last.pt"),
}
