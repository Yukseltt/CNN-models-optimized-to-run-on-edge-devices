...
#
#     Faster R-CNN labels are 1-based (background=0 reserved).
#     Faster R-CNN etiketleri 1-based'dir (background=0 ayrilmis).
    ...
    for thr in thresholds:
        ...
        if f1 > best_overall["f1"]:
            ...
            for k, name in enumerate(class_names):
                cls_label = k + 1  # +1 shift (Faster R-CNN label)
