# dataset.py
#
# Custom COCO Dataset for Torchvision Faster R-CNN.
# Torchvision Faster R-CNN icin custom COCO Dataset.
#
...
#
# Returns (image_tensor, target_dict) per Torchvision's Faster R-CNN contract.
# Torchvision Faster R-CNN beklentisine gore (image_tensor, target_dict) dondurur.
#
...
class CocoDetectionDataset(Dataset):
    # Custom COCO dataset that returns Faster R-CNN compatible targets.
    # Faster R-CNN uyumlu target dondurur custom COCO dataset.
    #
    # Args / Parametreler:
    ...
    def __init__(
        ...
        #
        # Torchvision Faster R-CNN reserves label 0 for background.
        # Torchvision Faster R-CNN, 0 etiketini background icin ayirir.
