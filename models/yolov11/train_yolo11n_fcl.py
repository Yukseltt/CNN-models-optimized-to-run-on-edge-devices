...
# Ensure project root is on sys.path so `src` can be imported when this
# script is run directly (e.g. `python models/yolov11/train_yolo11n_fcl.py`).
# Script direkt calistirildiginda `src` import edilebilsin diye proje kokunu
# sys.path'e ekler.
